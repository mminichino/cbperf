...
from .exceptions import (IsCollectionException, CollectionWaitException, ScopeWaitException, BucketWaitException,
                         ...
                         CollectionCountError, CollectionSubdocUpsertError, QueryArgumentsError, ClusterHealthCheckError,
                         QueryEmptyException, decode_error_code, IndexStatError, BucketStatsError, IndexQueryError,
                         ClusterInitError)
...
class cb_connect_s(cb_common):
    ...
    def cb_create_primary_index(self, replica=0, timeout=480):
        ...
        try:
            ...
            self._create_index(replica=replica)
        except QueryIndexAlreadyExistsException:
            pass
    ...
    def cb_create_index(self, field, replica=0, timeout=480):
        ...
        try:
            ...
            self._create_index(index_name=index_name, fields=[field], replica=replica)
        except QueryIndexAlreadyExistsException:
            pass

    def _create_index(self, fields=None, index_name=None, replica=1):
        try:
            if fields:
